    ...
    <div className="flex flex-col items-center justify-center py-16 px-4 space-y-4">
      ...
      <div className="relative w-36 h-16 flex items-center justify-center">
        ...
        <div className="absolute bottom-2 w-32 h-1 bg-slate-300 rounded-full overflow-hidden">
          <div className="w-12 h-full bg-emerald-500 rounded-full animate-[ping_1.5s_infinite]"></div>
        </div>
        {/* Bouncing & Driving Car */}
        <div className="animate-bounce flex flex-col items-center">
          <div className="p-3 bg-emerald-600 text-white rounded-2xl shadow-lg shadow-emerald-500/30 flex items-center justify-center transform hover:scale-105 transition-all">
